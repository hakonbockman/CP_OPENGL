...
public abstract class ShaderProgram {
	...
	public ShaderProgram(String vertexFile, String fragmentFile) {
		...
		// Attack fragmentShader and vertexShader to the program
		GL20.glAttachShader(programID, vertexShaderID);
		GL20.glAttachShader(programID, fragmentShaderID);
		
		// Bind attriutes need to be called BEFORE the link program
		bindAttributes();
	...
	// Makes sure all shader program classes will have a metod that gets all uniform locations, remember to put it in the constructor!
